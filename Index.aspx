<%@ Page Language="VB" MasterPageFile="~/MainStore.master" AutoEventWireup="false" CodeFile="Index.aspx.vb" Inherits="_Index" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="w3ls_w3l_banner_nav_left_grid" style="margin-bottom: 200px;">
        ...
        <br />
        <div class="clearfix"></div>
        <asp:LinqDataSource ID="DataSourceProducts" runat="server" ContextTypeName="LinqDBClassesDataContext" EntityTypeName="" OrderBy="IDP desc" TableName="Products">
        </asp:LinqDataSource>
        <asp:ListView ID="ListViewProducts" runat="server" DataSourceID="DataSourceProducts" DataKeyNames="IDP">
                                        ...
                                        <a href='#'>
                                            <div class="snipcart-thumb">
                                                <a href='/Products/<%# Eval("CatName").ToString.Replace(" ", "-")%>/<%# Eval("Name").ToString.Replace(" ", "-")%>/<%# Eval("IDP").ToString() %>'>
                                                    <img src='<%# Eval("Pic").ToString %>' alt='<%# Eval("Description").ToString %>' class="img-responsive" /></a>
                                                <p>
                                                    نام: <%# Eval("Name").ToString %><br />
                                                    توضیح: <%# Eval("Description").ToString %>
                                                </p>
                                                <h4>تومان <%# Convert.ToString(Eval("Price")) %> <span>تومان <%# Convert.ToString(Eval("Price") + 1000) %></span></h4>
                                            </div>
            ...
            <EmptyDataTemplate>
                <table style="">
                    <tr>
                        <td>درحال حاضر برای این گروه محصول، آیتمی جهت فروش وجود ندارد.</td>
                    </tr>
                </table>
            </EmptyDataTemplate>
            <InsertItemTemplate>
